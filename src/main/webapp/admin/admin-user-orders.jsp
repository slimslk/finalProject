...
<form action="${pageContext.request.contextPath}/controller" method="get">
 <input type="hidden" name="command" value="getalluserorders">
 <input type="hidden" name="userid" value="${userid}">
 <input  name="sDate" value="2021-07-21">
 <input  name="eDate" value="2021-07-25">
...
<c:if test="${not empty userOrdersF}">
 <c:forEach var="userOrder" items="${userOrdersF.userOrders}">
  <%--Order--%>
...
<c:if test="${empty userOrdersF}">
 <div class="text-center"><h3><fmt:message key="admin-orders.jsp.no.orders"/></h3></div>
</c:if>
